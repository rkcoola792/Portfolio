  ...
  return (
    ...
    >
      ...
      <div className="formContainer">
        <motion.div className="svg" initial={{opacity:1,}} whileInView={{opacity:0,transition:{
          delay:3,
          duration:1
        }}}>
          <svg
        ...
        <motion.div className="form" initial={{opacity:0}} whileInView={{opacity:1,transition:{
